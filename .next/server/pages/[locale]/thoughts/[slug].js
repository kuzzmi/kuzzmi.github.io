...
async function getStaticProps(ctx) {
    ...
    const post = (0,_lib_articles__WEBPACK_IMPORTED_MODULE_5__/* .getArticle */ .fq)("thoughts", slug);
...
function getStaticPaths() {
    const files = fs__WEBPACK_IMPORTED_MODULE_3___default().readdirSync("articles/thoughts");
...
var __webpack_exports__ = __webpack_require__.X(0, [895,664,245,570], () => (__webpack_exec__(5011)));
